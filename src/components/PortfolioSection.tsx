...
const PortfolioSection = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'Multi-channel marketing campaign that increased client conversion rates by 300%.',
    ...
    },
    {
      ...
      description: 'Cross-platform mobile application with offline capabilities and cloud synchronization.',
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Showcasing successful projects that have helped our clients achieve their business goals 
            and establish strong digital presence.
          </p>
        </div>
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="relative overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-nexedge-dark-blue/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                <div className="absolute top-4 left-4">
                  <span className="bg-nexedge-accent-blue text-white px-3 py-1 rounded-full text-xs font-medium">
                    {project.category}
                  </span>
                </div>
              </div>
              ...
              <CardContent className="p-6 space-y-4">
                <h3 className="text-xl font-semibold text-nexedge-dark-blue group-hover:text-nexedge-primary-blue transition-colors">
                  {project.title}
                </h3>
                ...
                <div className="space-y-2">
                  <h4 className="font-semibold text-nexedge-dark-blue text-sm">Technologies:</h4>
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech) => (
                      <span 
                        key={tech}
                        className="bg-gray-100 text-nexedge-dark-blue px-2 py-1 rounded text-xs font-medium"
                      >
                        {tech}
                      </span>
                    ))}

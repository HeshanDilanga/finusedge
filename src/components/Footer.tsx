const Footer = () => {
  ...
  return (
    <footer className="bg-finusedge-dark-blue text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="text-gray-300 hover:text-finusedge-accent-blue transition-colors"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <button
                ...
                className="block text-gray-300 hover:text-finusedge-accent-blue transition-colors text-sm"
              >
                Home
              </button>
              <button
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-gray-300 text-sm">hello@finusedge.com</p>
        ...
        <div className="border-t border-finusedge-navy mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm">
              © 2024 FinusEdge. All rights reserved.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              <a
                href="#"
                className="text-gray-300 hover:text-finusedge-accent-blue transition-colors text-sm"
              >
                Privacy Policy
              </a>
              <a

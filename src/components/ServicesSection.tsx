...
const ServicesSection = () => {
  const services = [
    ...
    },
    {
      ...
      description:
        "Strategic social media management to build your brand, engage audiences, and convert followers into customers.",
      image:
    ...
    },
    {
      title: "Web Design",
      description:
        "Beautiful, responsive websites that captivate visitors and provide exceptional user experiences across all devices.",
    ...
    },
    {
      ...
      description:
        "Creative visual solutions that communicate your brand message effectively and leave lasting impressions.",
    ...
    },
    {
      title: "IT Consulting",
      description:
        "Expert IT consulting services to optimize your technology infrastructure and streamline business operations.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            business growth and keep you ahead of the competition.
          </p>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="relative overflow-hidden rounded-t-lg">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-finusedge-dark-blue/60 to-transparent"></div>
              </div>

              <CardHeader>
                <CardTitle className="text-finusedge-dark-blue group-hover:text-finusedge-primary-blue transition-colors">
                  {service.title}
                </CardTitle>
              </CardHeader>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="grid grid-cols-2 gap-1">
                    {service.features.map((feature) => (
                      ...
                      >
                        <div className="w-1.5 h-1.5 bg-finusedge-accent-blue rounded-full mr-2"></div>
                        {feature}
                      </li>
                    ))}
                  </ul>
